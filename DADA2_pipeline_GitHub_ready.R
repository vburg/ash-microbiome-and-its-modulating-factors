...
#library(Biostrings); packageVersion("Biostrings")   ## [1] '2.52.0'
#library(ShortRead); packageVersion("ShortRead")     ## [1] '1.42.0'
#library(reshape2); packageVersion("reshape2")       ## [1] '1.4.3'
#library(gridExtra); packageVersion("gridExtra")     ## [1] '2.3'


library(dada2);packageVersion("dada2")              ## [1] '1.22.0'
library(ggplot2); packageVersion("ggplot2")         ## [1] '3.3.5'
library(phyloseq); packageVersion("phyloseq")       ## [1] '1.38.0'
...
# Die L?ufe sind ohne Primer noch 271 bp lang, 299 bp ist das Fragment nach dem
# merging beider reasds.
# angepasst von: truncLen=c(240,160)
# siehe Tabelle read_counts.xlsx
# 1. Auswertung mit truncLen=c(230,190)
# 2. Auswertung mit truncLen=c(225,155), truncLen=c(160,225)
